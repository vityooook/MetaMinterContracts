...
// const hex = "b5ee9c7201010101001700002a4d657461646174615f4f46465f4e46542e6a736f6e"
// const m = Cell.fromBoc(Buffer.from(hex, "hex"))[0]
// console.log(decodeContentItem(m))